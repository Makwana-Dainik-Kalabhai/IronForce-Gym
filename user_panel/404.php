...
<body>
    ...
    <section class="hero-section">
        <div class="hs-slider owl-carousel">
            <div class="hs-item set-bg" data-setbg="<?php echo HTTP_PATH . "/img/hero/hero-1.jpg"; ?>">
                <div class="container">
                    <div class="row">
            ...
            <div class="hs-item set-bg" data-setbg="<?php echo HTTP_PATH . "/img/hero/hero-2.jpg"; ?>">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-6">
                            <div class="hi-text">
    ...
    <section class="banner-section set-bg" data-setbg="<?php echo HTTP_PATH . "/img/banner-bg.jpg"; ?>">
        <div class="container">
            <div class="row">
    ...
    <div class="gallery-section">
        <div class="gallery">
            ...
            <div class="gs-item grid-wide set-bg" data-setbg="<?php echo HTTP_PATH . "/img/gallery/gallery-1.jpg"; ?>">
                <a href="img/gallery/gallery-1.jpg" class="thumb-icon image-popup"><i class="fa fa-picture-o"></i></a>
            </div>
            <div class="gs-item set-bg" data-setbg="<?php echo HTTP_PATH . "/img/gallery/gallery-2.jpg"; ?>">
                <a href="img/gallery/gallery-2.jpg" class="thumb-icon image-popup"><i class="fa fa-picture-o"></i></a>
            </div>
            <div class="gs-item set-bg" data-setbg="<?php echo HTTP_PATH . "/img/gallery/gallery-3.jpg"; ?>">
                <a href="img/gallery/gallery-3.jpg" class="thumb-icon image-popup"><i class="fa fa-picture-o"></i></a>
            </div>
            <div class="gs-item set-bg" data-setbg="<?php echo HTTP_PATH . "/img/gallery/gallery-4.jpg"; ?>">
                <a href="img/gallery/gallery-4.jpg" class="thumb-icon image-popup"><i class="fa fa-picture-o"></i></a>
            </div>
            <div class="gs-item set-bg" data-setbg="<?php echo HTTP_PATH . "/img/gallery/gallery-5.jpg"; ?>">
                <a href="img/gallery/gallery-5.jpg" class="thumb-icon image-popup"><i class="fa fa-picture-o"></i></a>
            </div>
            <div class="gs-item grid-wide set-bg" data-setbg="<?php echo HTTP_PATH . "/img/gallery/gallery-6.jpg"; ?>">
