...
<body id='pdf'>
    ...
    $address = unserialize($row["address"])["house-number"] . " " . unserialize($row["address"])["apartment"] . " near " . unserialize($row["address"])["suite"] . ", " . unserialize($row["address"])["city"] . " - " . unserialize($row["address"])["pincode"];
