                ...
                <div class="filter-group">
                    ...
                    <div class="sort-dropdown">
                        ...
                        <div class="sort-options" id="sortOptions">
                            <div class="sort-option" data-sort="start-date-asc">Start Date (Oldest)</div>
                            <div class="sort-option" data-sort="start-date-desc">Start Date (Newest)</div>
                            ...
                            <div class="sort-option" data-sort="duration-asc">Duration (Short to Long)</div>
                            <div class="sort-option" data-sort="duration-desc">Duration (Long to Short)</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            function initEventHandlers() {
                ...
                $('.sort-option').click(function() {
                    ...
                    $('#sortBtn').html(`<i class="fas fa-sort-amount-down"></i> ${$(this).text()}`);
