...
if (isset($_POST["submit"])) {
    ...
    if ($sel["email_exists"]) {
        ...
        $notification = $conn->prepare("INSERT INTO notification VALUES ('','" . $_SESSION["email"] . "', '2', 'Your Check-Out at <strong>INVIGOR FITNESS STUDIO</strong> has been Successfully Recorded. Thank You for your valuable Time.
